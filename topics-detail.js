const getparams = () => {
    ...
    fetch(`https://newspaper-nup9.onrender.com/news/articles/?search=${param}`)
    .then((res) => res.json())
    .then((data) => {
...
const loadRelatedArticles = (category) => {
    fetch(`https://newspaper-nup9.onrender.com/news/articles/?category=${category}`)
    .then((res) => res.json())
    .then((data) => {
...
const  loadReviewdetails = (article_id) => {
    fetch(`https://newspaper-nup9.onrender.com/news/ratings/?article_id=${article_id}`)
        .then((res) => res.json())
        .then((data) => {
