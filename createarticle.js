...
const loadCatagoryAndAuthor= () => {
    // Fetch categories
    fetch("https://newspaper-nup9.onrender.com/news/categories/")
    ...
    // Fetch authors
    fetch("https://newspaper-nup9.onrender.com/accounts/")
        .then(response => response.json())
        .then(authors => {
...
const CreateArticle = (event) => {
    ...
    fetch('https://newspaper-nup9.onrender.com/news/articles/', {
        method: 'POST',
        body: formData,
        headers: {
